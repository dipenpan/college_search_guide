...
The site focuses on **real decision-making factors** such as affordability, admission trends, academic offerings, and outcomes, presented through a clean, accessible interface.
...
- **CSS** – Custom global styling (no UI framework)  
